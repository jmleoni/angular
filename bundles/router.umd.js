/**
 * @license Angular v6.0.3-392a8546d
...
var PreActivation = /** @class */ (function () {
    ...
    function (futureNode, currNode, parentContexts, futurePath) {
        ...
        if (curr && future.routeConfig === curr.routeConfig) {
            ...
            if (shouldRunGuardsAndResolvers) {
                var /** @type {?} */ outlet = context ? context.outlet : null;
...
var Recognizer = /** @class */ (function () {
    ...
    function () {
        try {
            ...
            var /** @type {?} */ root = new ActivatedRouteSnapshot([], Object.freeze({}), Object.freeze(__assign({}, this.urlTree.queryParams)), /** @type {?} */ ((this.urlTree.fragment)), {}, PRIMARY_OUTLET, this.rootComponentType, null, this.urlTree.root, -1, {});
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var VERSION = new _angular_core.Version('6.0.3-392a8546d');
